...
def cadastrar_produto(estoque):
    ...
    # Aqui "produto" terá uma estrutura conhecida como "dicionário" no python
...
# Menu com estrutura para não fechar o menu enquanto o usuario não escolher a opção 3 - SAIR ↓ 
while True:
    print("\nSeja bem-vindo à Ultima Store, sua loja virtual!")
    opcao = int(input("O que você deseja fazer:\n 1) Cadastrar produto \n 2) Mostrar produtos \n 3) Filtrar produtos por preço \n 0) Sair do programa."))

    if opcao == 1: # Cadastra um novo produto ↓
        cadastrar_produto(estoque)    
    elif opcao == 2: # Apresenta TODOS os produtos cadastrados ↓
        mostrar_produto(estoque)
    elif opcao == 3: #Mostrar produtos dando um limite de preço ↓
        preco_max = float(input("Preço máximo: "))
        mostra_produtos_preco(estoque, preco_max) # Aqui chamamos o metodo passando os parâmetros
    elif opcao == 0: # Encerra o programa ↓
        print("Programa encerrado")
        break
    else: # Mostra mensagem e reinicia o MENU ↓
